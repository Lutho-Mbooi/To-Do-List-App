...
function CreateToDoItems() {
    if (todoValue.value === "") {
      ...
      if (IsPresent) {
        setAlertMessage("Item Already created");
        return;
      }
    ...
    todoValue.value = "";
    setAlertMessage("Item Added correctly");
  }
  ...
  function ReadToDoItems() {
    todo.forEach((element) => {
      ...
      ${
        style === ""
          ? ""
          : '<img class="todo-controls" src="/images/update.png" />'
      }</div><div>
      ${
        style === ""
          ? '<img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="/images/pencil.png" />'
  ...
  function DeleteToDoItems(e) {
    ...
    if (confirm(`This Item Will be permanently deleted ${deleteValue}!`)) {
